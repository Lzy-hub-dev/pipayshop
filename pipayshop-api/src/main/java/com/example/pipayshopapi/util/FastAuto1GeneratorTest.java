...
//.enableSwagger() // 开启 swagger 模式
                            ...
                            .outputDir("C:\\Users\\a7796\\Desktop\\temp"); // 指定输出目录
                })
                .packageConfig(builder -> {
                    builder.parent("com.example") // 设置父包名
                            .moduleName("pipayshopapi") // 设置父包模块名
                            .pathInfo(Collections.singletonMap(OutputFile.mapperXml, "C:\\Users\\a7796\\Desktop\\temp"));
// 设置mapperXml生成路径
                })
                .strategyConfig(builder -> {
                    builder.addInclude("item_commodity_history") // 设置需要生成的表名
