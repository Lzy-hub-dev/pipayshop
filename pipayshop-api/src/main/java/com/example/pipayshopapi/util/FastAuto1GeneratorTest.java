...
//.enableSwagger() // 开启 swagger 模式
                            ...
                            .outputDir("C:\\Users\\zhang\\Desktop"); // 指定输出目录
                })
                .packageConfig(builder -> {
                    builder.parent("com.example") // 设置父包名
                            .moduleName("pipayshopapi") // 设置父包模块名
                            .pathInfo(Collections.singletonMap(OutputFile.mapperXml, "C:\\Users\\zhang\\Desktop"));
// 设置mapperXml生成路径
                })
                .strategyConfig(builder -> {
                    builder.addInclude("b_user_withdrawal_record_info") // 设置需要生成的表名
